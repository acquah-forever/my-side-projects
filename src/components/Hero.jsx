  ...
  return (
    <div className="flex flex-col justify-center items-center">
      <div className="relative w-full h-210">
        ...
        <img className="loading-lazy w-full h-full object-cover object-center" src={Tech} alt="image" />
      </div>
      <div className='text-white p-5 space-y-7 absolute z-20 text-center'>
        <h1 className="font-bold text-5xl text-center">My Practice Projects</h1>
